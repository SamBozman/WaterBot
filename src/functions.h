...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void makeWaterTarget(int id, String name, long Stepper, long Hf, long Vs, long Vf, long spray, long rwt, bool W_on)
{
    ...
    doc["Name"] = name;
    doc["H_Steps"] = Stepper;  //(int) Horizontal steps from 'Home'
